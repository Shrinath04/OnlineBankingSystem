    ...
    <body>
        ...
        <section class="container-fluid bg">
            ...
            <div class="table-div">
                ...
                %>
                <div class="sendMoney-div">
                    <form action="closeMsg" method="post"><input type="hidden" name="msg" value="sendMoney"><button class="msg-close"><i class="fa-solid fa-xmark"></i></button></form>
                    <form class="sendMoney-form" action="sendMoney" method="post">
                        <%
                        if(friendAccNo!=null){
                        %>
                        <label>Send Money to : <%=friendAccNo%></label>
                        <%
                        }
                        %>
                        ...
                        <div class="form-group">
                            <label for="otp">OTP: (check Your mail) </label>
                            <input type="text" class="form-control" id="otp" name="otp" required>
                        </div>
                        <button type="submit" class="btn btn-success">Send Money</button><br><br>
                        <%
                            String error = (String) request.getAttribute("sendMoneyErr");
                            if (error != null) {
                                if (error.equals("success")) {
                                    request.setAttribute("sendMoneyErr", "nil");
                        %>
                        <h6 style="color:#0BDA51;text-align:center;font-weight: bold;">Money Sent Successfully!</h6>
                        <%
                        } else if (error.equals("invalidOtp")) {
                            request.setAttribute("sendMoneyErr", "nil");
                        %>
                        <h6 style="color:#FF3131;text-align:center;font-weight: bold;">Invalid OTP!</h6>
                        <%
                                }
