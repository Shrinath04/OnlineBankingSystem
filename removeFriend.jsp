    ...
    <body>
        ...
        <section class="container-fluid bg">
            ...
            <div class="table-div">
                ...
                %>
                <form class="removeFriend-form" action="removeFriend" method="post">
                    <%
                        if(friendAccNo!=null){
                    %>
                        <div class="form-group">
                            <label for="friendAccNo">Remove &nbsp;<%=friendAccNo %>?  </label>
                        </div>
                        <%
                        }
                        %>
                        ...
                        <button type="submit" class="btn btn-danger">Remove</button><br><br>
                    </form>
        </section>
