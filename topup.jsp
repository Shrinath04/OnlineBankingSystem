    ...
    <body>
        ...
        <section class="container-fluid bg">
            ...
            <div class="table-div">
                ...
                %>
                <form action="closeMsg" method="post"><input type="hidden" name="msg" value="topup"><button class="msg-close"><i class="fa-solid fa-xmark"></i></button></form>
                <form class="Topup-form" action="topup" method="post">
                    <%
                        if(cardNumber!=null){
                    %>
                    ...
                    %>    
                        <div class="form-group">
                            <label for="topupAmt">Top Up amount: </label>
                            <input type="text" class="form-control" id="topupAmt" name="topupAmt" required>
                        </div>
                        <button type="submit" class="btn btn-success">Top-Up</button><br><br>
                        <%
                            String error = (String) request.getAttribute("topupErr");
                            if (error != null) {
                                if (error.equals("success")) {
                                    request.setAttribute("topupErr", "nil");
                        %>
                        <h6 style="color:#0BDA51;text-align:center;font-weight: bold;">Top-Up Successful!</h6>
                        <%
